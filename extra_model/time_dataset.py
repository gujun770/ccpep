...
class TimeSeriesDataset(Dataset):
    def __init__(self,
        ...
        # self.data_frame_force = pd.read_csv(csv_file_force)
        # self.tensor_data_force = torch.tensor(self.data_frame_force.to_numpy(), dtype=torch.float32)
        # self.features_force = self.tensor_data_force[:, label_col_index + 1:]

    def __len__(self):
        return len(self.data_frame_polar)
