...
from utils.project_paths import HELM_DIR, resolve_dataset_path
...
class DatasetLabeled(Dataset):
    def __init__(self, path):
        ...
        with open(resolve_dataset_path('binding_vocab.json'), 'r', encoding='utf-8') as f:
            self.binding_vocab = json.load(f)
        with open(resolve_dataset_path('amino_acid_vocab.json'), 'r', encoding='utf-8') as f:
