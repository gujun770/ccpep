...
def parse_show(inputfile, show, outputfile, ip):
    ...
    if xpm_type == "Continuous" and ip == "yes":
        ...
        if outputfile != "":
            ...
            print("Info -> ", outputfile, " has been saved in present working directory")
        if show == "yes":
            if inputfile == 'gibbs.xpm':
                plt.savefig('gibbs.png', dpi=900)
            elif inputfile == 'enthalpy.xpm':
                plt.savefig('enthalpy.png', dpi=900)
            elif inputfile == 'entropy.xpm':
                plt.savefig('entropy.png', dpi=900)
            elif inputfile == 'prob.xpm':
                plt.savefig('prob.png', dpi=900)
            elif inputfile == 'covapic.xpm':
                plt.savefig('covapic.png', dpi=900)
            elif inputfile == 'gibbs_pc.xpm':
                plt.savefig('gibbs_pc.png', dpi=900)
            # plt.show()
